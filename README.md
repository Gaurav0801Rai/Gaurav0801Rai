...
**Tech:** Next.js • Firebase • LLM APIs • RAG • Groq • Gmail MCP

- Built an AI-powered portfolio platform for Indian Stocks & Crypto
- Owned the entire product lifecycle from user research to V1 launch
- Designed a zero-cost AI news pipeline filtering 95% irrelevant news
- Built a context-aware RAG chatbot for personalized portfolio analysis
- Iterated product using private beta user feedback

---

### 📈 Groww Review Analyzer | Voice of Customer Intelligence

**Tech:** LLMs • Embeddings • UMAP • HDBSCAN • Google Docs MCP

- Automated Play Store review analysis pipeline
- Clustered customer complaints using AI
- Eliminated manual review logging
- Reduced bug identification from days to hours
- Delivered automated stakeholder reports

---

### 🎤 ChatGPT Voice Adoption Research

**Tech:** User Research • Surveys • Interviews • Product Discovery

- Conducted user interviews and surveys with Indian users
- Identified barriers to voice adoption
- Built hypotheses around regional language accessibility
- Generated actionable product insights

---

### 🍱 Peppo Growth & Segmentation Case Study

**Tech:** Product Strategy • Growth • Segmentation • Analytics

- Identified high-value customer segments
- Proposed retention experiments
- Recommended growth initiatives
- Prioritized opportunities using PM frameworks

---

### 🏡 Smart Society | AI-Assisted MVP

**Tech:** Figma • Stitch AI • Product Design • User Journeys

- Designed an AI-powered society management MVP
...
- User Research & Problem Framing — NextLeap
- Prioritisation, Metrics & Growth — NextLeap

---

## 🏅 Achievements

- ⭐ Awarded **Star Performer of the Team** twice at Cognizant for delivering high-impact operational improvements
- 🚀 Built multiple AI-powered Product Management projects covering Product Discovery, User Research, MVP Planning, Growth Strategy, and AI-assisted product workflows
- 📱 Launched and iterated on user-facing AI products with successful beta engagement
